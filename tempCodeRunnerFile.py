...
.poster-container:hover {
        ...
        filter: brightness(0.8); /* Decrease brightness slightly for others */
    }

.poster-container.active {
        transform: scale(1.2); /* Slightly larger than hover */
        filter: brightness(1); /* Restore brightness */
        z-index: 2; /* Bring maximized poster to the front */
